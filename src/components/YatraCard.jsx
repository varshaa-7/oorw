    ...
    >
      <div className="relative overflow-hidden"> {/* Added overflow hidden */}
        <img
          ...
          className="w-full h-56 object-cover transition-transform duration-500 ease-in-out group-hover:scale-110" // Enhanced zoom effect
        />
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <p className="text-sm text-gray-600 mb-3 flex items-center">
         ...
         <div className="mt-auto pt-4 border-t border-gray-100"> {/* Separator */}
