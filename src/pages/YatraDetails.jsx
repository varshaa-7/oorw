  ...
  if (!tour) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        <h2 className="text-3xl font-semibold text-red-700 mb-4">Tour Not Found!</h2>
      ...
      <div className="bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-100">
        <div className="relative">
          <img
            src={tour.imageUrl}
            alt={tour.title}
            className="w-full h-80 sm:h-[500px] object-cover" // Taller image
          />
           ...
           <div className="absolute bottom-0 left-0 p-6 md:p-10">
             ...
             <p className="text-xl text-orange-300 font-medium shadow-md flex items-center gap-1"> <LocationIcon /> {tour.destination}</p>
           </div>
        </div>
        ...
        <div className="p-6 md:p-10">
             ...
             <div className="flex items-center">
              ...
              <div className="flex items-center">
                 ...
                 <div>
                    ...
                    <p className="text-lg font-medium text-gray-800">{tour.destination}</p>
                 </div>
             </div>
          </div>
          ...
          <div className="prose prose-lg prose-orange max-w-none text-gray-700 mb-10">
            ...
            <p>
              Embark on the spiritually enriching {tour.title} to the sacred city of {tour.destination}. This carefully planned pilgrimage offers a unique opportunity for devotion and introspection. Experience ancient rituals, visit revered temples, and immerse yourself in the divine atmosphere. Our package includes comfortable travel, quality accommodation, and knowledgeable guides to ensure a seamless and meaningful journey.
              {/* Add more specific description */}
            </p>
             <h4 className="font-semibold text-xl mt-6 mb-3 text-gray-800">Itinerary Highlights</h4>
             <ul>
                 <li>Day 1: Arrival, Check-in & Evening Aarti/Temple Visit</li>
                 <li>Day 2: Morning Rituals, Key Temple Darshans & Local Exploration</li>
                 <li>Day 3: Final Blessings & Departure</li>
                 {/* Expand with actual details */}
             </ul>
             <h4 className="font-semibold text-xl mt-6 mb-3 text-gray-800">Package Inclusions</h4>
             <ul className="list-disc list-outside ml-5 space-y-1">
                 <li>Comfortable AC Accommodation</li><li>Daily Breakfast & Dinner (Vegetarian)</li><li>All Transfers & Sightseeing by AC Vehicle</li><li>Experienced Tour Coordinator</li><li>Applicable Tolls & Taxes</li>
            </ul>
             <h4 className="font-semibold text-xl mt-6 mb-3 text-gray-800">Package Exclusions</h4>
             <ul className="list-disc list-outside ml-5 space-y-1">
                 <li>Airfare / Train Fare</li><li>Lunch, Personal Expenses (laundry, tips, etc.)</li><li>Special Pooja / Darshan Charges</li><li>Anything not mentioned in Inclusions</li>
            </ul>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 border-t border-gray-200 pt-8">
            <a
              href="https://www.razorpay.com" // <-- REPLACE
              target="_blank"
            ...
            >
             ...
             <Link
                to="/yatras"
                className="w-full sm:w-auto text-center text-gray-700 hover:text-orange-600 transition-colors duration-200 font-medium py-3 px-4 inline-flex items-center gap-1 sm:ml-auto" // Pushes to right on sm screens
              >
                 <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M7 16l-4-4m0 0l4-4m-4 4h18" /></svg>
                 Back to Yatras
              </Link>
